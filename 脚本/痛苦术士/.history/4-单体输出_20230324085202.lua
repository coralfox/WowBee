...
-- 目标身上有控制BUFF，不要捣乱
local ctr_buff_check = "致盲,凿击,昏迷,变形术,闷棍,致盲,圣盾术,保护之手" -----此为判定目标身上BUFF停手
local joylau =
...
local self_stop_buff = "猛踢,假死,机械路霸,X-53型观光火箭,奥的灰烬,点心,进食,喝水" -----坐骑和自身有BUFF停手
local unit_type = UnitCreatureType(tar)
local uTypeCheck = BeeStringFind(unit_type, "亡灵,恶魔,人型生物")
local n = "多彩混乱" -- 宁神
local j =
    "钓鱼,学习,乱射,暴风雪,炉石,潜行,偷窃,开启,打开,开锁,枯萎凋零,凛风冲击,寒冬号角" -----读条停手
