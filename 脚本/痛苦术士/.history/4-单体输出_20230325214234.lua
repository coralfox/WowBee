...
if unit_can and mod_can and IsSpellInRange("暗影箭") == 1 then
    ...
    if BeeStringFind(npc_check(), "精英,首领,小怪") then
        ...
        if (BeeSpellCD("鬼影缠身") > 0 or BeeTargetDeBuffTime("鬼影缠身") >= 3) and
            ...
            print("鬼影缠身的CD:" ..
                      BeeSpellCD("鬼影缠身" .. "\r鬼影缠身buff时间:" .. BeeTargetDeBuffTime("鬼影缠身") ..
                                     "\r痛苦无常buff时间:" .. BeeTargetDeBuffTime("痛苦无常") ..
                                     "\r当前施法:" .. BeeUnitCastSpellName(p) .. "\r当前施法时间:" .. cur_time ..
                                     "\r当前施法剩余时间:" .. cur_castingTime))
