...
if unit_can and mod_can and IsSpellInRange("暗影箭") == 1 then
    ...
    elseif npc_check() == "小怪" then
        ...
        if BeeTargetDeBuffTime("鬼影缠身") >= 2 and BeeTargetDeBuffTime("痛苦无常") >= 4 and BeeTargetDeBuffTime("痛苦诅咒") >= 6 and BeeUnitHealth(src, "%") > 25 and BeeUnitHealth(src) > 800 and BeeIsRun("/cast 射击") and unit_can and mod_can
        then
            spell_cast("射击",3,"sj")
            return
        end
