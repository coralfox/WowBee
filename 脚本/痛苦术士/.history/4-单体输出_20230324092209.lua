...
local rest_toggle = true -- true为休息不执行,false为手动休息
...
if BeeStringFind(tarCtrBuff, Tbl) or BeeStringFind(self_buff, buff) or selfStopCastSpell then
    return
end

-- 目标有可打断的技能，打断
if daduan_can and tar_Castingtime - tar_time > 1 and tar_time > 1 and unit_can then
