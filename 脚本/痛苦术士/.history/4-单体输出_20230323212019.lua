...
if  BeeIsRun("/cast 暗影箭") and unit_can and mod_can
then
...
if unit_can and mod_can and IsSpellInRange("暗影箭") == 1 then
 ...
 then
    ...
    elseif npc_check() == "杂碎" then
        ...
        if and BeeTargetDeBuffTime("痛苦诅咒") >= 6 and BeeUnitHealth(src, "%") > 25 and BeeUnitHealth(src) > 800 and BeeIsRun("/cast 射击") and unit_can and mod_can
        then
            spell_cast("射击",3,"sj")
            return
        end
