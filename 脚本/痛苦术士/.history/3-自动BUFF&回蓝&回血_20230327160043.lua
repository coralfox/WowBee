...
if GetSpellName("邪甲术") and BeePlayerBuffTime("邪甲术") < 1 and BeeUnitMana(p, "%", 0) >= p_mana and
    BeeIsRun("/cast 邪甲术") then
    BeeRun("/cast 邪甲术")
elseif GetSpellName("邪甲术") and BeePlayerBuffTime("魔甲术") < 1 and BeeUnitMana(p, "%", 0) >= p_mana and
    BeeIsRun("/cast 魔甲术") then
    BeeRun("/cast 魔甲术")
elseif GetSpellName("邪甲术") and BeePlayerBuffTime("恶魔皮肤") < 1 and BeeUnitMana(p, "%", 0) >= p_mana and
