...
elseif GetSpellName("魔甲术") 
if  BeePlayerBuffTime("魔甲术") < 1 and BeeUnitMana(p, "%", 0) >= p_mana and
    BeeIsRun("/cast 魔甲术") then
    BeeRun("/cast 魔甲术")
    elseif GetSpellName("恶魔皮肤") if BeePlayerBuffTime("恶魔皮肤") < 1 and BeeUnitMana(p, "%", 0) >= p_mana and
