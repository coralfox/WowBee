...
local zls_type = {"次级治疗石", "治疗石", "强效治疗石", "优质治疗石", "特效治疗石",
                  "超级治疗石", "符文治疗石"}
local ys_type = {"初级治疗药水", "次级治疗药水", "治疗药水", "强效治疗药水", "优质治疗药水",
                 "特效治疗药水", "超级治疗药水", "符文治疗药水"}
...
-- 死亡缠绕
if BeeUnitHealth(p, "%") < sc_hp and BeeSpellCD("死亡缠绕") == 0 and BeeIsRun("/cast 死亡缠绕", src) and
...
-- #################自动回血(宝宝)##################
-- 不在战斗状态则自动回血
if BeeUnitMana("pet", nil) >= pet_mana and BeeUnitHealth("pet", "%") <= pet_hp and BeeIsRun("/cast 吞噬暗影", "pet") and
    not BeeUnitAffectingCombat("pet") and not IsMounted(p) and BeeSpellCD("吞噬暗影") == 0 then
